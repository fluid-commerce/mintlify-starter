---
title: "FairShare Cart API: JavaScript Methods and HTML Controls"
...
Fire custom events and inspect attribution state directly from your JavaScript code.

```javascript
// Fire a custom event into the Fluid attribution pipeline
