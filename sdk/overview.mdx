...
<CardGroup cols={2}>
  <Card title="Attribution Tracking" icon="crosshairs">
    Credit the right sales rep for every sale using a multi-signal chain that combines cookies, browser fingerprints, and URL parameters. Attribution is resolved server-side so it cannot be spoofed or lost across page navigations.
  </Card>
