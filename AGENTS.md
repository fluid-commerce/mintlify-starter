...
- Banned legacy references in docs content: `company/v1`, `/api/v1/`, `v2025-06` / `v202506`. Three exceptions, each tied to a named surface, each verified against the implementation rather than the spec, and each scoped explicitly — an exception to one is not an exception to another:
