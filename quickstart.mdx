---
title: "Get Started with Fluid We-Commerce"
sidebarTitle: "Quickstart"
description: "Learn how to set up your Fluid account, install FairShare, and make your first API call in under 10 minutes."
---
...
<Steps>
  ...
  <Step title="Install the FairShare SDK">
    ...
    ```html
    <script
      src="https://cdn.fluid.app/fairshare/v1/fairshare.min.js"
      data-company-id="YOUR_COMPANY_ID"
      async
    ></script>
    ```

    Replace `YOUR_COMPANY_ID` with the company ID found in **Admin Settings → Developer**. FairShare works on any domain — including sites you don't fully control — so you can attribute sales from affiliate pages, microsites, and partner storefronts without additional configuration.
  </Step>
  ...
  <Step title="Make your first API call">
    ...
    ```bash
    curl -X GET https://api.fluid.app/api/company/v1/products \
