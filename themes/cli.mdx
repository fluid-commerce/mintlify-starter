---
title: "Fluid CLI for Theme Development"
sidebarTitle: "CLI"
...
This opens the `admin.fluid.app` authentication flow in your browser. After you approve access, the CLI stores a token locally for future commands.
