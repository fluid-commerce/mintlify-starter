...
<CardGroup cols={2}>
  ...
  <Card title="Section slots" icon="table-columns" href="/themes/section-slots">
    Build reusable Liquid containers with named drag-and-drop slots for whole sections.
  </Card>
  ...
  <Card title="Member storefront" icon="id-badge" href="/themes/member-storefront/overview">
    Show member prices and greetings in cached sections, and give members their own pages inside the active theme.
  </Card>
