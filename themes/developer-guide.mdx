---
title: "Developer Guide: Building and Customizing Fluid Themes"
sidebarTitle: "Developer Guide"
description: "Learn how to build and customize Fluid themes using Liquid templating, JSON section schemas, components, assets, and locale files for translations."
---
...
| `member_price` | Render a product or variant price as a member-aware shell that the member storefront SDK resolves for a signed-in member. See [Member-aware sections](/themes/member-storefront/member-aware-sections) |
