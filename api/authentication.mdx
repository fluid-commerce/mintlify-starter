...
<Note>
  Programmatic management of partner and public tokens — creating, rotating, and revoking them — is handled in the Fluid dashboard under **Settings → API Tokens**. A published API reference for token management is forthcoming.
</Note>
